  ...
  return (
    <nav className="fixed z-20 bg-white w-full flex justify-between nav-shadow items-center px-[32px] xl:px-[130px] py-[30px]">
      <div className="flex items-center gap-[20px]">
        <Link className="flex items-center gap-[9px]" to='/payper'>
          <img className="w-[35px]" src={logo} alt="logo" />
          <h3 className="text-second-blue font-bold">PayPer</h3>
        </Link>
        <button className="hidden lg:block text-white hover:bg-main-blue bg-second-blue text-[15px] font-semibold px-[10px] py-[5px] rounded-2xl duration-150 ease-in-out">
          Personal
        </button>
      </div>
